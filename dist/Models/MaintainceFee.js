...
const MaintainceFeeSchema = new mongoose_1.Schema({
...
MaintainceFeeSchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        const MaintainceFeeData = this;
        if (MaintainceFeeData.MaintainceFeeProblemKey) {
            const ProblemKeyFeeExist = yield Problem_1.default.exists({
...
const MaintainceFee = mongoose_1.default.model("MaintainceFee", MaintainceFeeSchema);
exports.default = MaintainceFee;
//# sourceMappingURL=MaintainceFee.js.map